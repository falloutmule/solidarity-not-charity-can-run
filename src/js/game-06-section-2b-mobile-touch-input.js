...
function crPortraitLookSensMultiplier(){
  ...
  if(isMobilePortrait()){
    ...
    if(BUILD_ID === 'feel2' || BUILD_ID === 'walltextures1' || BUILD_ID === 'walltextures2' || BUILD_ID === 'walltextures3') mult *= FEEL2_PORTRAIT_LOOK_SOFTEN;
    return mult;
  }
  return 1.06;
}
...
function crGetFeel2LookTuningProof(){
  ...
  return {
    ...
    PORTRAIT_LOOK_BOOST,
    FEEL2_PORTRAIT_LOOK_SOFTEN: BUILD_ID === 'feel2' || BUILD_ID === 'walltextures1' || BUILD_ID === 'walltextures2' || BUILD_ID === 'walltextures3' ? FEEL2_PORTRAIT_LOOK_SOFTEN : null,
    portraitLookMultiplier: mult,
    effectiveMobileLookSens: optSens * mult,
    feel1PortraitMultiplier: feel1Mult,
    percentReductionVsFeel1Portrait: BUILD_ID === 'feel2' || BUILD_ID === 'walltextures1' || BUILD_ID === 'walltextures2' || BUILD_ID === 'walltextures3' ? Math.round((1 - FEEL2_PORTRAIT_LOOK_SOFTEN) * 1000) / 10 : 0,
