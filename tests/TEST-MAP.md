...
| `authoring/buildings/dumpster_001/`, generated `dumpster_001.asset.js`, dumpster Tiled example, short bitmap geometry | `test:dumpster-pilot`, `test:dumpster-binary-cutout`, `test:dumpster-pilot-runtime`, `test:short-building-geometry`, `test:building-asset-compiler`, `test:building-asset-preview` |
