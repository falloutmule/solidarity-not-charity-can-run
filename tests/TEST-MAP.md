...
| `authoring/asset-gallery/`, `authoring/concepts/`, `tools/*asset-gallery*` | `gallery:validate`, `gallery:build`, `test:asset-gallery-registry`, `test:asset-gallery-build`, `test:asset-gallery-runtime-reuse`; production artifact parity |
