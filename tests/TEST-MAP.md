...
| `authoring/buildings/dumpster_001/`, generated `dumpster_001.asset.js`, dumpster Tiled example, alpha-cutout geometry | `test:dumpster-pilot`, `test:dumpster-pilot-runtime`, `test:alpha-cutout-raycaster`, `test:short-building-geometry`, `test:building-asset-compiler`, `test:building-asset-preview` |
