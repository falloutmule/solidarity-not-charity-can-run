...
const CANONICAL_URL = 'https://falloutmule.github.io/solidarity-not-charity-can-run/';
...
assert.deepStrictEqual(identity.diagnostics, {
  metadata: metadata.runtime.buildId,
  source: metadata.runtime.buildId,
  artifact: metadata.runtime.buildId,
...
console.log(JSON.stringify({
  ...
  buildId: metadata.runtime.buildId,
