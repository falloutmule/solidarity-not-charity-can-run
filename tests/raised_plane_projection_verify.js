...
const source = requireSource('src/js/game-16d-heightfield-renderer.js', ['const rowDepth = RH * eyeDelta / (y - horizon);', 'crHeightfieldTopMaterialId(profile)', 'crHeightfieldMaterialRgb', 'worldDepthPixels[index] = rowDepth', 'putImageData']);
