...
const renderer = requireSource('src/js/game-16d-heightfield-renderer.js', ['canVisiblePixels', 'canOccludedPixels', 'npcVisiblePixels', 'npcOccludedPixels', 'crHeightfieldPhysicalSpriteBounds(kind, obj, tex, hp)', 'crProjectHeightfieldVisibleSprite(obj, tex, hp, depth, hscr, bounds)']);
