...
- Functions like `CR.runLayoutSelfCheck()`, `CR.runFullSelfCheck()`, `CR.runOnboardingSelfCheck()`, `CR.runVisualReadabilitySelfCheck()`, `CR.runHallSelfCheck()`, etc.
...
| `proof-visual-normal.png` … `proof-visual-onboarding.png` | Visual proof screenshots |
