...
- Building source authority is `authoring/buildings/<id>/building.json` plus one reusable transparent face PNG. Directional overrides are optional.
...
- The Phase 8 pilot is fictional `dumpster_001`, footprint 1×2. Its upper face half is transparent and the lower half contains the visible dumpster.
