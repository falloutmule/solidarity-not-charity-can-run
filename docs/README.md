...
The public documentation is intentionally small and living. Raw audits, proof output, branch inventories, and dated handoffs are kept in the private project archive.

| Document | Authority |
|---|---|
| [Game Design](design/GAME-DESIGN.md) | Approved product direction, rules, content, and acceptance criteria |
